...
from handlers import registration, adding_case, record_observations
...
async def command_start_handler(message: Message):
    if check_user(message.from_user.id):
        ...
        await message.answer(f'Привет! Мы ещё не знакомы. Давай зарегистриуемся?', reply_markup=registration_kb)
